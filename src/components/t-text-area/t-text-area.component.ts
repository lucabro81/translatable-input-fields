import html from './t-text-area.html';
...
export class TTextArea implements IWebComponent {
   ...
   */
  connectedCallback() {
    console.log('t-text-area connected');
  }
  ...
  disconnectedCallback() {
    console.log('t-text-area disconnected');
  }
